...
5. VALORES SÃO CALCULADOS POR CÓDIGO: NÃO cite valores monetários (R$) nos capítulos, nem faça aritmética. Todos os valores de rescisão, aviso prévio, 13º, férias, FGTS+multa, dano moral, honorários e demais verbas são calculados por código (mathUtils) e figuram APENAS no rol de pedidos. Mencione os reflexos (DSR, aviso prévio, férias +1/3, 13º, FGTS +40%) de forma qualitativa, sem números. Qualquer "R$ ..." no seu texto será removido pela pós-edição — não os inclua.
